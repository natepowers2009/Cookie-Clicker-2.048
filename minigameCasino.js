...
M.launcher = function(){
  ...
  new Cppkies.Upgrade(
  "Raise the stakes",
  "Can <b>bet a minute of CPS at a time.</b><q>Now we're getting somewhere!</q>",
  10,
  [0, 3, M.iconsImage]
  );
  new Cppkies.Upgrade(
  "High roller!",
  "Can bet an hour of CPS at a time.<q>Now we're getting somewhere!</q>", 
  10, 
  [0, 3, M.iconsImage]
  );
	new Cppkies.Upgrade(
  "Math lessons",
  "Show the value of your current blackjack hand.<q>C'mon, it's not that hard.</w>",
  1,
  [0, 3, M.iconsImage]
  );
  new Cppkies.Upgrade(
  "Counting cards",
  "Keeps track of which cards have been played. 2-6 increase the count by 1. 10-k and Aces decrease the count by 1. Higher counts give better odds.<q>Technically not cheating, but casinos frown on this sort of thing.</q>",
  21,
  [0, 3, M.iconsImage]
  );
	new Cppkies.Upgrade(
  "Tiebreaker",
  "Ties push to the player, not the dealer.<q>Look at me. I'm the dealer now.</q>",
  15,
  [0, 3, M.iconsImage]
  );
  new Cppkies.Upgrade(
  "I make my own luck",
  "Each chancemaker gives a <b>0.0<span></span>3%</b> chance to instantly win the hand.<q>Wait, that's illegal.</q>",
  60,
  [0, 3, M.iconsImage]
  );
	new Cppkies.Upgrade(
  "Infinite Improbability Drive",
  "Chancemaker chance to instantly win the hand is <b>doubled</b>.<q>You stole a prototype spaceship just to cheat at cards?</q>",
  180,
  [0, 3, M.iconsImage]
  );
	new Cppkies.Upgrade(
  "Double or nothing",
  "Multiply your bet by <b>2</b>. <q>The Martingale System sounds good on paper, but one losing streak long enough will bankrupt anyone.</q>",
  120,
  [0, 3, M.iconsImage]
  );
  new Cppkies.Upgrade(
  "Stoned Cows",
  "Multiply your bet by <b>5</b>.<w>The steaks have never been higher!</q>",
  300,
  [0, 3, M.iconsImage]
  );
  new Cppkies.Upgrade(
  "Actually, do tell me the odds",
  "Display the probabilites of various outcomes of taking an action in the Casino,<q>2 + 2 is 4 minus 1 that's 3 quick maffs.</q>",
  21000000,
  [0, 3, M.iconsImage],
  38,
  -188,
  []
    ...
    "Card minnow",
    "Win <b>21</b> hands of blackjack.",
    [0, 3, M.iconsImage]
);
		new Cppkies.Achievement(
    "Card trout",
    "Win <b>210</b> hands of blackjack.",
    [0, 3, M.iconsImage]
);
	new Cppkies.Achievement(
    "Card shark",
    "Win <b>2100</b> hands of blackjack.",
    [0, 3, M.iconsImage]
);
	new Cppkies.Achievement(
    "Five card stud",
    "Win a hand of blackjack with <b>5</b> cards in your hand. <q>Wait, what game are you playing again?</q>",
    [0, 3, M.iconsImage]
);
	new Cppkies.Achievement(
    "Why can't I hold all these cards?",
    "Win a hand of blackjack with <b>6</b> cards in your hand.",
    [0, 3, M.iconsImage]
);
		Game.last.pool = 'shadow';
  new Cppkies.Achievement(
    "Ace up your sleeve",
    "Win <b>13</b> hands of blackjack through chancemaker intervention in one ascension.<q>I'll tell you what the odds are.</q>",
    [0, 3, M.iconsImage]
);
  new Cppkies.Achievement(
    "Paid off the dealer",
    "Win <b>" + (13 * 13) + "</b> hands of blackjack through chancemaker intervention in one ascension.<q>Takes money to make money.</q>",
    [0, 3, M.iconsImage]
);
  new Cppkies.Achievement(
    "Deal with the Devil",
    "Win <b>666</b> hands of blackjack through chancemaker intervention in one ascension.<q>Just sign right here.</q>",
    [0, 3, M.iconsImage]
);
		Game.last.pool = 'shadow';
  new Cppkies.Achievement(
    "Blackjack!",
    "Be dealt a hand totaling 21 naturally.",
    [0, 3, M.iconsImage]
)
 	new Cppkies.Achievement(
    "I like to live dangerously",
    "Hit on <b>19</b> or above without going over <b>21</b> <q>My name is Number 2. This is my Italian confidential secretary. Her name is Alotta. Alotta Fagina.</q>",
    [0, 3, M.iconsImage]
)
  new Cppkies.Achievement(
    "I also like to live dangerously",
    "Win with a score of <b>5</b> or less.<q>Yeah baby!</q>",
    [0, 3, M.iconsImage]
)
